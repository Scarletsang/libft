...
/*   Updated: 2023/08/04 04:19:24 by htsang           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_ft_parser_decorator decorator, struct s_ft_parser_entity *entity)
{
	return ((struct s_ft_parser_entity){
		...
		.construct = {.as_decorator = ft_decorator_curry(decorator, entity)}});
}
...
size_t amount)
{
	return ((struct s_ft_parser_entity){
		...
		.construct = {.as_combinator = ft_combinator_curry(\
			combinator, entities, amount)}});
}
